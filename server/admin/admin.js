...
const settingLabels = {
  ...
  transcriptRepetitionMinimumRepeats: 'ASR repetition minimum repeats',
  transcriptRepetitionMaximumPatternWords: 'ASR repetition maximum pattern words',
  transcriptRepetitionMinimumCoverage: 'ASR repetition minimum coverage',
  transcriptMaximumWordsPerSecond: 'ASR maximum credible words per second',
