...
function up(db) {
  // SQLite cannot alter CHECK constraints in place; recreate devices with mobile support.
  db.exec(`
    CREATE TABLE devices_new (
      ...
      kind TEXT NOT NULL CHECK (kind IN ('browser','desktop','mobile','import','wearable')),
