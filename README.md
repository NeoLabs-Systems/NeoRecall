...
- **Inference stays replaceable.** NeoRecall bundles no speech-recognition or language model. Use a hosted provider or a compatible service you deploy elsewhere; provider and model choices are configurable in the app's Admin page and in `.env`.
