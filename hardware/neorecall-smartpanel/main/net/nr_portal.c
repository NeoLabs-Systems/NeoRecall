...
":root{--bg:#0E1511;--card:#171F1A;--gold:#E1B052;--tx:#ECEFE5;--mut:#AEB7A6;--bd:#2a332c}"
...
".ring{width:32px;height:32px;border-radius:9px;background:#2A5740;position:relative}"
".ring:after{content:'';position:absolute;inset:6px;border:3px solid var(--gold);border-radius:50%}"
/* Even 8px + -4px margin keeps the core on whole pixels (7px/-3.5 was off). */
".ring:before{content:'';position:absolute;left:50%;top:50%;width:8px;height:8px;margin:-4px 0 0 -4px;"
"background:#EEE3CC;border-radius:50%;z-index:2}"
