...
function resolvePreferredGitBranch(channel) {
  ...
  if (normalized === 'stable') return getReleaseChannelBranch(normalized);
  ...
  if (preferred === 'beta' && !gitRemoteBranchExists('beta')) return 'main';
  return preferred;
}
...
async function cmdInstall(args = []) {
  ...
  if (!dependenciesReady()) installDependencies();
