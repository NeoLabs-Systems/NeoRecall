...
/// touched, never an arbitrary file found in the directory.
...
/// A file left by a previous pinned model can have the expected name and the
/// wrong contents. Readiness must distinguish it from the current search model.
///
