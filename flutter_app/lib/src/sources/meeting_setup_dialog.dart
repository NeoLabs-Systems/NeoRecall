...
class MeetingAccountPanel extends StatefulWidget {
  const MeetingAccountPanel({required this.controller});

  final NeoRecallController controller;

  @override
  State<MeetingAccountPanel> createState() => _MeetingAccountPanelState();
}

class _MeetingAccountPanelState extends State<MeetingAccountPanel> {
...
class RemoteSignInView extends StatefulWidget {
  const RemoteSignInView({required this.controller, required this.session, required this.onFinished});
  ...
  @override
  State<RemoteSignInView> createState() => _RemoteSignInViewState();
}

class _RemoteSignInViewState extends State<RemoteSignInView> {
...
class MeetingSetupDialog extends StatefulWidget {
  const MeetingSetupDialog({required this.controller});

  final NeoRecallController controller;

  @override
  State<MeetingSetupDialog> createState() => _MeetingSetupDialogState();
}

class _MeetingSetupDialogState extends State<MeetingSetupDialog> {
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            MeetingAccountPanel(controller: widget.controller),
            const SizedBox(height: 16),
            TextField(
