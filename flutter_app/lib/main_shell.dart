...
class NeoRecallShell extends StatelessWidget {
  ...
  static const items = <(RecallPage, IconData, String, String)>[
    (RecallPage.record, Icons.radio_button_checked_rounded, 'Record', 'Capture'),
    ...
    (RecallPage.speakers, Icons.record_voice_over_outlined, 'Speakers', 'People'),
        ...
        builder: (context, constraints) {
          ...
          if (compact) {
            return Scaffold(
              ...
              drawer: Drawer(
                child: SafeArea(
                  child: _Sidebar(controller: controller, labeled: true, drawer: true),
                ),
              ),
              body: content,
            );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: drawer ? BorderRadius.zero : BorderRadius.circular(AppRadius.panel),
      ...
      child: Column(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(labeled ? 8 : 0, 4, labeled ? 8 : 0, 18),
          ...
          if (labeled)
            Align(
              ...
              child: Padding(
                ...
                child: Text('CONTROL SURFACE', style: sectionEyebrowStyle(palette)),
              ),
            ),
          ...
          if (labeled) ...<Widget>[
            MetaPill(
              icon: controller.online ? Icons.cloud_done_outlined : Icons.cloud_off_outlined,
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: onTap,
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: labeled ? 12 : 10, vertical: labeled ? 12 : 14),
          child: Row(
            children: <Widget>[
              Icon(icon, color: selected ? palette.accentHover : palette.textSecondary),
              if (labeled) ...<Widget>[
